...
class SolRPC {
  ...
  async getTransaction({ txid }) {
    ...
    if (lookupTablesUsed) {
      ...
      return {
        ...parsedTransaction,        
        // instructions: parsedTx.transaction.message.instructions, // <- removing this line will pass through parsedTransaction's instructions from our decodeRawTransaction method
        meta: parsedTx.meta,
